...
import 'package:brick_converter/model/brick_color.dart';
...
class BrickConverterLogic {
  ...
  _loadColors() async {
    String data = await rootBundle.loadString('assets/color_table.csv');
  ...
  _loadGoBricks() async {
    String data = await rootBundle.loadString('assets/gobrick_conversion_table.csv');
